...
// Any select/status/multi_select property found on an SOP's Notion page is
// shown as a badge — deliberately not hardcoded to specific property names,
// since this reads whatever the Notion database's own schema happens to be.
